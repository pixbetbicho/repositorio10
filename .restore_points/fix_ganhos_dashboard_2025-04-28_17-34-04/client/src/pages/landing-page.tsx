          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                A melhor plataforma para jogar o tradicional jogo do bicho com segurança e emoção.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><Link href="/auth" className="hover:text-white transition-colors">Entrar</Link></li>
                <li><Link href="/auth?tab=register" className="hover:text-white transition-colors">Cadastrar</Link></li>
                {user && (
                  <li><Link href="/user-dashboard" className="hover:text-white transition-colors">Minha Conta</Link></li>
                )}
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#" className="hover:text-white transition-colors">Regras do Jogo</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li className="flex items-center">
                  ...
                  <span>suporte@pixbetbicho.com</span>
                </li>
                <li className="flex items-center">
                  <span className="mr-2">📱</span>
