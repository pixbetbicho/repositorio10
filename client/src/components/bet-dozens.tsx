...
export function BetDozens({ 
  ...
  // Cálculo do potencial de ganho com o valor real da aposta
  const potentialWinAmount = Math.floor(formValues.amount * multiplier); // Cálculo direto com valor da aposta em reais
