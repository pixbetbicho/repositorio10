 ...
 * @param isDivideByHundred se verdadeiro, divide o valor por 100 antes de formatar (corrige valores armazenados em centavos)
 * @returns string formatada no padrão brasileiro
 */
export function formatCurrency(value: number | string, isDivideByHundred = true): string {
  ...
  // Corrige o valor para formato em reais (centavos/100)
  // Muitos sistemas armazenam valores monetários em centavos (4200 = R$ 42,00)
  if (isDivideByHundred) {
    value = value / 100;
  }
